...
public class CurrencyConversionController {
			...
			@PathVariable BigDecimal quantity)
	{
		...
		ResponseEntity<CurrencyConversionBean> responseEntity = new RestTemplate().getForEntity("http://localhost:8000/currency-exchange/from/EUR/to/INR", CurrencyConversionBean.class, uriVariables);
